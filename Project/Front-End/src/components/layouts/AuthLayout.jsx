...
const AuthLayout = ({ title = "", children }) => {
    const style = {
        ...
        boxShadow: 'rgba(0, 0, 0, 1) 0px -200px 200px 0px inset',
        ...
        <PageAnimation>
            <div className="dark:text-white flex text-gray-800 p-4 md:py-6 md:px-4 lg:p-0 ">
                <div className="flex flex-col-reverse lg:flex-row w-screen lg:min-h-screen border shadow-sm rounded-lg overflow-hidden lg:border-none lg:shadow-none lg:rounded-none lg:overflow-auto">
                        ...
                        <div>
                            <div className="space-y-8 p-5 font-Julee_cursive ">
                                ...
                                <div className="dark:text-white space-y-4">
                                    ...
                                    <p className="dark:text-white font-Satisfy text-md">
                    ...
                    <div className="dark:bg-[#111827]  flex dark:text-white flex-col justify-center bg-slate-100 lg:min-h-screen p-6 md:p-10 lg:p-8 xl:p-10 w-full lg:w-5/12 xl:w-2/5 ">
                        {children}
                    </div>
                </div>
            </div>
