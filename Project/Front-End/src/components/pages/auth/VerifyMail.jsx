  ...
  return (
    <>
      ...
      <div className="mt-5 flex place-content-center">
        <div className="max-w-sm p-8  place-content-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="flex place-content-end">
            <RouterLink
              to="/login"
              className="inline-flex items-center text-blue-600 hover:underline place-items-end"
            >
              Go to login
              <svg
